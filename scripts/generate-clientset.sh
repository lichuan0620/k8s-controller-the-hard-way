...
# copied from https://github.com/kubernetes/code-generator/blob/master/generate-groups.sh
...
(
  ...
  cd "$(dirname "${0}")"
  go install k8s.io/code-generator/cmd/{defaulter-gen,client-gen,lister-gen,informer-gen,deepcopy-gen}@v0.24.0
)
